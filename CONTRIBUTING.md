...
1. Version bump: Bump the version number in `package.json`, `package-lock.json`, `global/docker-compose.yml`, and any other relevant files if it does not already reflect the version being released.
