...
const downloadDevelop = function( env ) {
    ...
    execSync( `cd ${envPath} && docker run -t --rm -v ${envPath}/wordpress:/usr/src/app -v ${envUtils.cachePath}/npm:/root/.npm 10up/wpcorebuild:latest npm install`, { stdio: 'inherit' });
